                ...
                try {
                    ...
                    if (statusCode == 200) {
                        ...
                        if (object instanceof SynergykitObject) {
                            ...
                            try {
                                Synergykit.callback(callbacks, response, statusCode)
                            } catch (e) {
                            ...
                            try {
                                Synergykit.callback(callbacks, result, statusCode)
                            } catch (e) {
                                console.error(e.stack)
                                if (Synergykit.errorCallback) {
                                    Synergykit.errorCallback({
        ...
        res.on("end", function() {
            try {
                ...
                if (statusCode == 200) {
                    ...
                    Synergykit.batches = []
                    try {
                        Synergykit.callback(callbacks, resultCallback, statusCode)
                    } catch (e) {
                        console.error(e.stack)
                        if (Synergykit.errorCallback) {
                            Synergykit.errorCallback({
