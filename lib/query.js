...
Query.prototype.isEqualTo = function(parameter) {
    this.query["$filter"] += " eq " + checkParameter(parameter)
    return this
}

Query.prototype.isNotEqualTo = function(parameter) {
    this.query["$filter"] += " ne " + checkParameter(parameter)
    return this
}

Query.prototype.isGreaterThan = function(parameter) {
    this.query["$filter"] += " gt " + checkParameter(parameter)
    return this
}

Query.prototype.isGreaterOrEqual = function(parameter) {
    this.query["$filter"] += " ge " + checkParameter(parameter)
    return this
}

Query.prototype.isLessThan = function(parameter) {
    this.query["$filter"] += " lt " + checkParameter(parameter)
    return this
}

Query.prototype.isLessOrEqualThan = function(parameter) {
    this.query["$filter"] += " le " + checkParameter(parameter)
    return this
}
