...
exports.get = function(data) {
    checkConnection(data)
    data.synergykit._start = new Date().getTime()
    if (data.synergykit.debug) {
    ...
    listeners["got"] = function(result) {
        if (result.hash == hash) {
            if (data.synergykit.debug) {
                data.synergykit._end = new Date().getTime()
                console.log("Success (time: " + data.synergykit.calcTimeDiff() + "): GET", "/data/" + data.object.collection)
            }
...
exports.create = function(data) {
    ...
    listeners["err"] = function(result) {
        if (result.hash == hash) {
            if (data.synergykit.debug) {
                data.synergykit._end = new Date().getTime()
                console.log("Success (time: " + data.synergykit.calcTimeDiff() + "): POST", "/data/" + data.object.collection)
            }
            errorCallback(data, result.data)
        }
    }
...
exports.update = function(data) {
    ...
    listeners["updated"] = function(result) {
        if (result.hash == hash) {
            if (data.synergykit.debug) {
                data.synergykit._end = new Date().getTime()
                console.log("Success (time: " + data.synergykit.calcTimeDiff() + "): PUT", "/data/" + data.object.collection)
            }
            successCallback(data, result.data)
        }
    }
...
exports.destroy = function(data) {
    ...
    listeners["deleted"] = function(result) {
        if (result.hash == hash) {
            if (data.synergykit.debug) {
                data.synergykit._end = new Date().getTime()
                console.log("Success (time: " + data.synergykit.calcTimeDiff() + "): DELETE", "/data/" + data.object.collection)
            }
            successCallback(data, result.data)
        }
    }
